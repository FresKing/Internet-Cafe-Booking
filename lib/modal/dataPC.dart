class DataPC {
  ...
  static List<DataPC> VIPlist() {
    return [
      ...
      DataPC('assets/images/VIP 2.jpg', 'Neon Setup','Located in the prestigious downtown business district, InterContinental Dhaka is the foremost name of luxury. The hotel is beautifully designed boasted with Millennium modern outlook with a touch of local culture. Featuring 226 luxury rooms and suites, a selection of restaurants offering exquisite cuisines. Host your events at the meeting spaces equipped with modern facilities. ', 15000),


      DataPC('assets/images/VIP 3.jpg', 'Pan Pacific Sonargaon','Be inspired by the vibrancy surrounding our premier hotel in Dhaka. Located in the heart of the City Centre, our luxurious accommodation offers a calming respite from the hustle and bustle of downtown Dhaka, where contemporary comfort will refresh your senses. We welcome you with our plush rooms, modern amenities and a promise of peace at Pan Pacific Sonargaon Dhaka.',  15000),


      DataPC('assets/images/VIP 4.jpg', 'Sea Pearl Beach Resort',"Sea Pearl Beach Resort & Spa is located on Inani beach, Cox's Bazar with lush green hills rise from the east and endless sea stretching on the west, the resort offers panoramic visuals of Bay of Bengal. Nestled in the heart of nature along the world’s longest natural sandy beach, the resort is spread over 15 acres",  15000),


      DataPC('assets/images/VIP 5.jpg', 'The Westin','Conveniently placed just 8 km away from Hazrat Shahjalal International Airport, The Westin Dhaka boasts a spacious swimming pool and offers free Wi-Fi at all areas. It also houses 5 restaurants.Located just 1 km away from Shopper’s World Mall, the property is also a 8 km away from the historical Bahadur Shah Park Memorial.' ,  15000),
    ];
  }
