class Hotel {
 ...
 static List<Hotel> hotellist() {
    return [
      ...
      Hotel('assets/images/VIP 2.jpg', 'InterContinental','Located in the prestigious downtown business district, InterContinental Dhaka is the foremost name of luxury. The hotel is beautifully designed boasted with Millennium modern outlook with a touch of local culture. Featuring 226 luxury rooms and suites, a selection of restaurants offering exquisite cuisines. Host your events at the meeting spaces equipped with modern facilities. ', "", 11990 , 4.4),
  ...
  static List<Hotel> PeoplechoiceList(){
   return[
     ...
     Hotel('assets/images/renaissance.webp', 'Renaissance',"Conveniently located in the most dynamic and inspiring neighborhood of Gulshan, Renaissance Dhaka Gulshan Hotel is ideal for business and leisure travelers alike. Enjoy easy access to the Hazrat Shahjalal International Airport, just 20 minutes away, and experience the distinctive local character that dictates the atmosphere and experiences for guests. Discover sophisticated elements and uber design throughout the 211 stylish rooms and suites. The infinity rooftop temperature-controlled pool with a stunning city vista view will take your breath away" , "",  13000, 4.2),

     Hotel('assets/images/soangaonroyal.png', 'Sonargaon Royal',"Welcome to Sonargaon Royal ResortWe welcome you to our resort as you enlighten our abode with your warmth and smiley nature. We are truly grateful to you for your visit here and hope to have memorable moments throughout your visit." , "",  10500, 4.1),

     Hotel('assets/images/hotelgrandpark.png', 'Hotel Grand Park',"Hotel Grand Park Barisal aims to exceed all expectations as we welcome guests from around the globe. With this in mind, you will find our business and recreation facilities prepare you to take on the world - or the bustle of busy city." , "",  11000, 4.1),

     Hotel('assets/images/seagull.png', 'Seagull',"Welcome to SEAGULL HOTEL where business and leisure blend together. Enjoying an unrivalled location, overlooking the Bay of Bengal (only 25 yards from the Bay water) and sitting in the laps of hills, we offer deluxe accommodation in 181 well appointed guest rooms and suites. The panoramic view of the ocean, the majestic hills and the natural beauty of the tamarisk trees are all wonderfully complemented by luxury facilities and Bangladeshi hospitality." , "",  12900, 4.2),

     Hotel('assets/images/grandsultan.png', 'Grand Sultan', "The one & only five star resort in the Sylhet region of Bangladesh. Equipped with all modern state of the art amenities and facilities, located in Srimongal (the tea capital of Bangladesh), around four hours drive from Dhaka. This resort is the true combination of ultimate luxury, gracious hospitality and admirable greenery. Classified in 08 categories with 135 hotel rooms and suites Grand Sultan welcomes you in Sylhet to enjoy your holiday or vacation with comfort and luxury.",  "", 80000, 4.7),

     Hotel('assets/images/mostofa2.jpg', 'Grand Mostofa \n Hotel  Ababil',"A place where traditional meets contemporary. A place to escape, relax, and enjoy. A place to dine with confidence. A place for special occasions. A place to remember. That is Hotel Grand Mostafa. Grand Mostafa located in Sylhet welcomes respite and tranquil relaxation guests can delight in spacious rooms well equipped to offer truly elevated experienced with modern amenities." , "",  9900, 4.1),
     ...
     Hotel('assets/images/palace.png', 'The Palace \n Luxury Resort'," Come lose yourself in the largest resort in Bangladesh in the heart of breathtaking pristine nature. Indulge in a regal experience like no other at The Palace Luxury Resort in Bahubal, Habiganj. Book an escape to this Kingdom of tranquility and experience life the Palace way.", "", 14000, 4.5),
   ];
  }
